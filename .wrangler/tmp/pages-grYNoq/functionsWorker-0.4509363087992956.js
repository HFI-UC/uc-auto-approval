...
var ApprovalStatus = /* @__PURE__ */ ((ApprovalStatus2) => {
  ...
  ApprovalStatus2["MANUAL_REVIEW"] = "MANUAL_REVIEW";
...
var responseSchema = {
  ...
  properties: {
    decision: {
      type: Type.STRING,
      enum: ["APPROVED" /* APPROVED */, "REJECTED" /* REJECTED */, "MANUAL_REVIEW" /* MANUAL_REVIEW */],
...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    const jsonText = response?.text ? String(response.text).trim() : "";
    if (!jsonText) {
...
// ../.wrangler/tmp/pages-grYNoq/functionsRoutes-0.36815383477297825.mjs
var routes = [
  {
...
// C:/Users/Jeffery/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/Jeffery/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
